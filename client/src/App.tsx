...
function Router() {
  ...
  return <><SeoHead/><Switch><Route path="/" component={Home}/><Route path="/library" component={Home}/><Route path="/pricing" component={Home}/><Route path="/about" component={Home}/><Route path="/contact" component={Home}/><Route path="/guides/:slug" component={Home}/><Route path="/auth" component={Home}/><Route path="/account" component={Home}/><Route path="/admin/unlocks*" component={Home}/><Route path="/404" component={NotFound}/><Route component={NotFound}/></Switch></>;
}
