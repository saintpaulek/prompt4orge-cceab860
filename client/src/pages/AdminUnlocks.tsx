...
export default function AdminUnlocks() {
  ...
  return <main className="admin-page">
    <div className="admin-head"><Link href="/account" className="back-link"><ArrowLeft size={15}/> Back to account</Link><div className="eyebrow"><span className="pulse"/> ADMIN WORKSHOP / 05</div><div className="admin-title-row"><div><h1>Forge unlock codes.</h1><p>Generate one-time access keys for members, keep distribution tight, and track every code after it leaves the workshop.</p></div><div className="admin-badge"><ShieldCheck size={15}/> ADMIN ONLY</div></div></div>
